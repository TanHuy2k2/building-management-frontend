    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-semibold text-green-600">{availableSlots}</div>
          </CardContent>
        </Card>
      </div>
            ...
            {slots.map((slot) => (
              <div
                ...
                className={`p-4 rounded-lg border-2 text-center ${
                  slot.occupied ? 'border-blue-500 bg-blue-50' : 'border-gray-200 bg-white'
                }`}
              >
                <ParkingCircle
            ...
            {registrations.map((reg) => (
              <div key={reg.id} className="flex items-center justify-between p-4 border rounded-lg">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm font-semibold">{reg.price.toLocaleString()} VNĐ</p>
